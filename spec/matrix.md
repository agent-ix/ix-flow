...
| FR-004      | Test         | `tests/commands.test.ts` (status reports phase)                                                         |
...
| FR-009      | Test         | `tests/commands.test.ts` (add-item persists)                                                            |
...
| FR-017      | Test         | `tests/commands.test.ts` (resume re-emits status)                                                       |
| FR-018      | Test         | `tests/commands.test.ts` (history returns events)                                                       |
| FR-019      | Test         | `tests/commands.test.ts` (update-item patches by id)                                                    |
| FR-020      | Test         | `tests/commands.test.ts` (link-items records a link)                                                    |
| FR-021      | Analysis     | `src/workflow-core/store.ts` (`stateVersion`), `src/workflow-core/errors.ts`                            |
